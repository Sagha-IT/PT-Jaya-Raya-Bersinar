...
<?php //die();
/*
Login 2024foreverptjrb pass email

Login akun microsoft PT Jaya Raya Bersinar
...
//echo @mengacakstring("2024foreverptjrb",5); die();
...
<li><a href="<?php echo $lokasiweb; ?>gerai/"><i style="font-size:26px !important;" class='whiledesk fab fas fa-donate <?php echo ($sekarangdimana==="gerai"?" menuonactcure ":""); ?>'></i><span class="whilehp <?php echo ($sekarangdimana==="gerai"?" menuonactcure ":""); ?>">Gerai</span></a> </li>
...
<li><a href="<?php echo $lokasiweb; ?>?metode=logoutgerai"><i style="font-size:26px !important;" class='whiledesk fas fa-power-off'></i><span class="whilehp">Log Out</span></a> </li>
<?php }; ?>
...
{echo "<div style=\"padding:4% 8%;width:92%;\"><h2> Selamat datang ".$namasekolah."</h2>Mohon Maaf, laman yang Anda cari tidak ada di website kami</div>";}
?>

<footer class="footer"> <!-- CONTAINER -->
<div class="container">
<div class="row foorow-2 foorow"> 
<div class="col-sm-4"> <h3 class="text-bold">Kontak Kami</h3> <address> No Telp Line 1 : <a href="tel:<?php echo $notel; ?>" target="_blank"><?php echo $notel; ?></a> <br> No Telp Line 2 : <a href="tel:+6285719496835" target="_blank">+6285719496835</a> <br> <a href="mailto:<?php echo @$alamatemail; ?>"><?php echo @$alamatemail; ?></a><br> <br> 
Kp. Pondok bahar Rt 005, Rw. 002.<br/>Kel. Pondok Bahar,
Kec: Karang Tengah<br/>Kota Tangerang, Banten, 15159
